      ...
      <div className="max-w-4xl mx-auto bg-white border border-slate-200 rounded-2xl p-8 shadow-sm space-y-6">
        ...
        <section className="space-y-2">
          ...
          <p className="text-slate-700">
            ...
            90 días desde cierre/resolución/derivación. En empresas, la retención depende de la configuración del cliente empresa.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="text-slate-700">
            Solo compartimos datos con proveedores técnicos necesarios para operar (hosting, correo, infraestructura), bajo
        ...
        <section className="space-y-2">
          ...
          <p className="text-slate-700">
            ...
            técnico de rotación, con retención limitada.
          </p>
        </section>

        <section className="space-y-2">
          <h2 className="text-xl font-semibold">9. Modificaciones de la política</h2>
          <p className="text-slate-700">
            Podemos actualizar esta política para reflejar mejoras de seguridad, cambios regulatorios o ajustes operativos.
            La versión vigente será la publicada en este sitio con su fecha de actualización.
          </p>
        </section>

        <p className="text-sm text-slate-500">
          Esta política se complementa con los <Link className="text-emerald-700 font-medium" to="/terminos">Términos y Condiciones</Link> y
          la <Link className="text-emerald-700 font-medium ml-1" to="/cookies">Política de Cookies</Link>.
        </p>
      </div>
    </div>
  );
