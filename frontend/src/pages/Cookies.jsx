    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 px-6 py-16 pt-24">
      <div className="max-w-4xl mx-auto bg-white border border-slate-200 rounded-2xl p-8 shadow-sm space-y-6">
        ...
        <section className="space-y-2">
          ...
          <p className="text-slate-700">
            RFA utiliza principalmente cookies técnicas y de seguridad, incluyendo cookies de sesión y mecanismos de
            proteccion contra solicitudes maliciosas (CSRF). Estas cookies son necesarias para autenticacion y uso del panel.
          </p>
        </section>

        <section className="space-y-2">
          <h2 className="text-xl font-semibold">3. Gestión de cookies por el usuario</h2>
          <p className="text-slate-700">
            El usuario puede configurar su navegador para bloquear o eliminar cookies. Dicha configuracion puede afectar el
            funcionamiento de login, renovación de sesión y otras funciones esenciales.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="text-slate-700">
            Esta política puede modificarse por cambios técnicos, operativos o regulatorios. La versión vigente será la
        ...
        <p className="text-sm text-slate-500">
          Revisa también los <Link className="text-emerald-700 font-medium" to="/terminos">Términos y Condiciones</Link> y la{" "}
          <Link className="text-emerald-700 font-medium" to="/privacidad">Política de Privacidad</Link>.
        </p>
      </div>
    </div>
  );
